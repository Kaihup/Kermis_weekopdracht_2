...
public class Kermis {
    ...
    /**
     * Initeren van alle kermis Attracties
    ...
    HashMap<Character, Attractie> plaatsAttracties() {
        ...
        tePlaatsenAttracties.put('2', new SpinAttractie("Spin", 2.25, (14.50 * 10.00), 5));
        ...
        tePlaatsenAttracties.put('5', new HawaiiAttractie("Hawaii", 2.90, (15.00 * 13.00), 10));
